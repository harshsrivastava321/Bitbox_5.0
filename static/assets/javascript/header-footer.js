...
<div class="container-fluid px-3 px-md-4">
  ...
  <div class="d-flex align-item pt-2 pb-2 pr-2s-center">
    <a class="navbar-brand shadow-soft py-2 px-3 rounded border border-light mr-xl-4" href="#">
      ...
      <span class="ml-2 text-dark" style="font-size: large;"><i class="fas fa-chart-pie"></i>&nbsp &nbsp PREDPOL INDIA</span>
    </a>
  </div>
...
align-items: center;">
    <div class="col-3 "><i class="fas fa-copyright"></i> 2025 PREDPOL INDIA | All rights reserved </div>
</div>
</footer>
